...
function mover() {
    ...
    muchos.forEach((e) => {
        e.style.transform += `translateY(${velocidad}px) translateX(${valor}px)`;
...
// Selecciona los pedales
let pedalIzquierda = document.getElementById('pedalIzquierda');
let pedalDerecha = document.getElementById('pedalDerecha');

// Funciones para mover el coche
...
// Asocia los eventos de clic a los pedales
pedalIzquierda.addEventListener('mousedown', moverIzquierda);
pedalDerecha.addEventListener('mousedown', moverDerecha);

pedalIzquierda.addEventListener('mouseup', () => p.xv = 0);
pedalDerecha.addEventListener('mouseup', () => p.xv = 0);
